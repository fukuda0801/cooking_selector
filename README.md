...
- #### お気に入り料理機能
    ...
    ユーザー本人以外のお気に入り料理一覧を閲覧することはできません。(URLを変更してもログインユーザーの情報が表示されます。)  
...
- #### コメント機能
    ...
    ユーザーがこれまでにコメントした内容を一覧で確認できます。 
    ユーザー本人以外のコメント一覧を閲覧することはできません。(URLを変更してもログインユーザーの情報が表示されます。)   
    <img src="public/user_comment.png" width="70%">
- #### 管理画面 (Active Admin)
